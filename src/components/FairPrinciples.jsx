          ...
          <table>
            ...
            <tr>
              ...
              <td>
                ...
                <ul>
                  ...
                  <li>
                    Mention any particularities or limitations about the data that other users
                    should be aware of.
                  </li>
                  <li>
                  ...
                  <li>
                    Ensure that all variable names are explained or self-explanatory (i.e., defined
                    in the research field’s controlled vocabulary).
                  </li>
                  <li>
            ...
            <tr>
              ...
              <td>
                ...
                documentation available at <a href="http://docs.aireadi.org">docs.aireadi.org</a>{' '}
            ...
            <tr>
              ...
              <td>
                ...
                <ul>
                  <li>Name files and directories following a consistent naming convention</li>
                </ul>
                <ul>
                  <li>
              ...
              <td className="align-top">
                ...
                community standards. More details are provided in the{' '}
                <a href="https://cds-specification.readthedocs.io/en/v0.1.0/">
                  CDS specification documentation
                </a>{' '}
                .
                <p>
                  ...
                  dataset documentation available at{' '}
                  <a href="http://docs.aireadi.org">docs.aireadi.org</a>.
                </p>
              </td>
            </tr>
          </table>
