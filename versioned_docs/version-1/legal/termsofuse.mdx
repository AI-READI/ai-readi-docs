...
title: Terms of Use
image: https://kalai.fairdataihub.org/api/generate?title=Terms%20of%20Use&description=&app=ai-readi-docs&org=ai-readi
---
...
The website located at https://docs.aireadi.org is a copyrighted work belonging to Fair Data Innovations Hub. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.
...
### Waiver of className or Consolidated Actions
