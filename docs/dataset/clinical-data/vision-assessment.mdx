...
All data were entered into a RedCap form titled BCVA, which is available in our full list of recording forms [here](https://docs.aireadi.org/files/REDCap%20surveys%20and%20forms.pdf).
...
All data were entered into REDCap under BCVA, which is available in our full list of recording forms [here](https://docs.aireadi.org/files/REDCap%20surveys%20and%20forms.pdf).
...
All data were entered into RedCap under Photopic MARS or Mesopic MARS, which is available in our full list of recording forms [here](https://docs.aireadi.org/files/REDCap%20surveys%20and%20forms.pdf).
