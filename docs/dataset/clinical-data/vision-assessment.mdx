...
All data were entered into RedCap under Photopic MARS or Mesopic MARS, which is available in our full list of data instruments [here](https://docs.aireadi.org/files/REDCap%20surveys%20and%20forms.pdf).
...
<table>
  ...
  <tbody>
    <tr>
      <td rowSpan="2">1</td>
      <td rowSpan="2">Photopic Right eye (OD) CS</td>
      <td>OD: Value of final correct letter(1.44)</td>
    </tr>
    <tr>
      <td>OD: Number of misses prior to stopping(1.0)</td>
    </tr>
    <tr>
      <td rowSpan="2">2</td>
      <td rowSpan="2">Photopic Left eye (OS) CS</td>
      <td>OS: Value of final correct letter(1.44)</td>
    </tr>
    <tr>
      <td>OS: Number of misses prior to stopping(1.0)</td>
    </tr>
    <tr>
      <td rowSpan="2">3</td>
      <td rowSpan="2">Mesopic Right eye (OD) CS</td>
      <td>OD: Value of final correct letter(1.28)</td>
    </tr>
    <tr>
      <td>OD: Number of misses prior to stopping(1.0)</td>
    </tr>
        <tr>
      <td rowSpan="2">4</td>
      <td rowSpan="2">Mesopic Left eye (OS) CS</td>
      <td>OS: Value of final correct letter(1.44)</td>
    </tr>
    <tr>
      <td>OS: Number of misses prior to stopping(1.0)</td>
