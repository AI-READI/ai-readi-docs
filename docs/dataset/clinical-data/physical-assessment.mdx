...
### File Processing
The .csv file can be opened and processed using notebook application or any coding language example:( Python, R). Here is a snippet code to extract Height.

```
Code Example : Extract Height
Syntax : python
import pandas as pd
...
|measurement_concept_id |Concept ID for the type of measurement | 4245997 | 3025315|
