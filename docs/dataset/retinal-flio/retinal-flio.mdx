...
1. **Overview of available images**
...
2. Data standards: Currently there are no SOP Classifications for FLIO in DICOM, as this is a relatively new technology. To reflect this, 1.2.840.10008.5.1.4.1.1.77.1.5.xxxxx was used as the value of SOP Class UID.
...
import RetinalFlioData from '@site/src/components/RetinalFlioData';
