...
- The `Preliminary Information` section contains information about accessing and using the dataset so you can understand what is expected from users of the dataset. This includes information about the license associated with the dataset, training prerequisites, the mini-subset version of the dataset, and Azure Storage access.
